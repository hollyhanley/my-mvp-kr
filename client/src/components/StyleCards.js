...
function StyleCards() {
    return (
        <div className="row">
            ...
            <div className="card">
                  <img src="https://i.pinimg.com/564x/c2/a6/4b/c2a64b0ea3ad67bb95816fa99b98c00a.jpg" 
                  className="card-img-top" alt="American Traditional"/>
                  <div className="card-body">
                    <h5 className="card-title">American Traditional</h5>
                    <p className="card-text">Also known as American Trad. A style with clean black outlines, vivid colours, minimal shading, and imagery of roses, anchors, and ladies. In 1930’s these tattoos symbolised a rejection of the American dream.</p>
                  </div>
                </div>
            </div>
            ...
            <div className="col-sm-6 col-md-6 col-lg-3">
            <div className="card">
                  <img src="https://i.pinimg.com/564x/e0/a0/ea/e0a0ea1a2ac76f91831efa6aae7aad9c.jpg" 
                  className="card-img-top" alt="Black & Grey"/>
                  <div className="card-body">
            ...
            <div className="col-sm-6 col-md-6 col-lg-3">
            <div className="card">
                  <img src="https://i.pinimg.com/564x/33/42/fd/3342fd7cdc0514a06ff5bb3393969263.jpg" 
                  className="card-img-top" alt="Destrutturato"/>
                  <div className="card-body">
            ...
            <div className="col-sm-6 col-md-6 col-lg-3">
            <div className="card">
                  <img src="https://i.pinimg.com/564x/f3/8f/b0/f38fb06a31523e17ffc42d115b5c2674.jpg" 
                  className="card-img-top" alt="Etching/ Woodcut"/>
                  <div className="card-body">
            ...
            <div className="col-sm-6 col-md-6 col-lg-3">
            <div className="card">
                  <img src="https://i.pinimg.com/564x/ea/8d/cf/ea8dcfbd2725f15cfae037fe736311f9.jpg" 
                  className="card-img-top" alt="Fineline"/>
                  <div className="card-body">
            ...
            <div className="col-sm-6 col-md-6 col-lg-3">
            <div className="card">
                  <img src="https://i.pinimg.com/564x/3f/43/3b/3f433bf47e60802b6c56213321ca0233.jpg" 
                  className="card-img-top" alt="Geometric"/>
                  <div className="card-body">
            ...
            <div className="col-sm-6 col-md-6 col-lg-3">
            <div className="card">
                  <img src="https://i.pinimg.com/564x/70/97/ee/7097ee84d789b373006769d3c98cc737.jpg" 
                  className="card-img-top" alt="Handpoke"/>
                  <div className="card-body">
            ...
            <div className="col-sm-6 col-md-6 col-lg-3">
            <div className="card">
                  <img src="https://i.pinimg.com/736x/5a/ef/7e/5aef7ee947c178384778d56c80ee22f4.jpg" 
                  className="card-img-top" alt="Japanese"/>
                  <div className="card-body">
          ...
          <div className="col-sm-6 col-md-6 col-lg-3">
            <div className="card">
                  <img src="https://i.pinimg.com/474x/03/67/ca/0367ca562d77ff2953160aad07ff04a6.jpg" 
                  className="card-img-top" alt="Lettering"/>
                  <div className="card-body">
            ...
            <div className="col-sm-6 col-md-6 col-lg-3">
            <div className="card">
                  <img src="https://i.pinimg.com/564x/11/3d/e4/113de4ba8d689efde3375dd7de0c6228.jpg" 
                  className="card-img-top" alt="Neo-traditional"/>
                  <div className="card-body">
            ...
            <div className="col-sm-6 col-md-6 col-lg-3">
            <div className="card">
                  <img src="https://i.pinimg.com/564x/cf/fb/94/cffb9482e76a2dba61520058c78b4fb0.jpg" 
                  className="card-img-top" alt="Trash Polka"/>
                  <div className="card-body">
            ...
            <div className="col-sm-6 col-md-6 col-lg-3">
            <div className="card">
                  <img src="https://i.pinimg.com/564x/12/ed/9f/12ed9fca5f154df6fb4d657d53efac2c.jpg" 
                  className="card-img-top" alt="Watercolour"/>
                  <div className="card-body">
